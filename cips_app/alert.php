...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <header class="w3-container" style="padding-top:22px">
    <h5><b><i class="fa fa-dashboard"></i> News & Alerts <!-- <?php echo $first_name; ?> --></b></h5>
  </header>

  <div class="w3-row-padding w3-margin-bottom">
     <?php 
     $row = $obj->fetch_record("notification");
     foreach($row as $key) {
          # code...
      //print_r($row1);
      //die;
   ?>
     <div class="w3-panel w3-leftbar w3-sand w3-large w3-serif w3-animate-left">
        <p>
          <i>"<?php echo $key['msg']; ?>"</i>
          <br><span style="font-size: 12px;font-family: cursive;">Posted On: <?php echo $key['notify_date']; ?></span>
        </p>
     </div>
   <?php }?>
