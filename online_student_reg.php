...
// print_r($_FILES);die;
  $fname = $obj->test_input($_POST['fname']);
   $addmis_date =  $obj->dateformatusa($_POST['addmis_date']);
...
<!--   menu -->
  <center>
    <div class="container">
      ...
      <h3>Registration Form</h3><h4>Session: 2021-22</h4>
      <h6><?php echo $dup; ?></h6>
    </div>
  </center>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" autocomplete="off" type="text" name="session" id="session" placeholder="Enter Job Discription" value="2021-22" readonly=""> 
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Date of Birth <span style="color: red;">(dd-mm-yyyy)</span></label> 
                                                <input class="form-control" autocomplete="off" type="text" name="dob" id="dob" placeholder="Enter date of birth"> 
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
...
<script type="text/javascript">
  ...
  $('#dob').inputmask("99-99-9999");  //static mask
