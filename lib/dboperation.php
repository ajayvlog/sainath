...
function check_duplicate($table_name,$where)
{
	...
	$sqledit = mysqli_query($con,"SET NAMES utf8");
...
{
	//echo "Called";
	//http://bulksms.trinitysolutions.pw/sendsms.jsp?user=miliap&password=Panav@27&sms=hello&mobiles=9770131555&sender=MILAAP
...
function uploadImage($con,$imgpath,$docname)
{
//	echo $imgpath;die;
	//print_r($docname);
	//die;
...
function cound_days($first,$last)
{
	$startTimeStamp = strtotime($first);
	$endTimeStamp = strtotime($last);
