...
$pagename = "send_sms_employee.php";
$module = "Send SMS To Employee";
$submodule = "Send SMS To Employee";
$btn_name = "Search";
$keyvalue =0 ;
if(isset($_POST['sendsms']))
{
	...
	echo "<script>location='send_sms_employee.php';</script>";
}
        	...
        	<div class="contentinner">
                ...
                <h4 class="widgettitle"><?php echo $submodule; ?> List</h4>
                  ...
                  <div class="span4" style="margin-left:0px;overflow:scroll; height:400px;">
                      ...
                      <?php
                      $slno = 1;
                      $sql = $obj->executequery("select * from m_employee");
