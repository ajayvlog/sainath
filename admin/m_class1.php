	...
	// 		} 
		...
		// else{
			//insert
				if($keyvalue == 0)
			  {    
				$form_data = array('class_id'=>$class_id,'subject'=>$subject,'ipaddress'=>$ipaddress,'createdby'=>$loginid,'createdate'=>$createdate);
				...
				//update
				$form_data = array('class_id'=>$class_id,'subject'=>$subject,'ipaddress'=>$ipaddress,'createdby'=>$loginid,'lastupdated'=>$createdate);
