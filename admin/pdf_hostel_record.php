...
class PDF_MC_Table extends FPDF
{
  ...
  var $aligns;
    ...
    function Header()
    {
        ...
        $this->Cell(42,8,'Stu_Name/Bio_code',1,0,'L',0);
...
//$pdf->setCellMargin(5);
    ...
    $pdf->Row(array($slno++,$stu_name." / ".$biometric_code,$father_name,$mother_name,$mobile,$admission_year,$room_no." / ".$floor_name." / ".$hostel_name,$dob,$parent_mobile));
}
