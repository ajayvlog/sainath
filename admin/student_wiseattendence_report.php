...
$pagename = "student_wiseattendence_report.php";
$module = "Student Wise Attendance Report";
$submodule = "Student Wise Attendance Report";
$btn_name = "Search";
$keyvalue =0 ;
            ...
            <div class="contentinner">
              <?php include("../include/alerts.php"); ?>
                ...
                <div class="widgetcontent  shadowed nopadding">
                    <form class="stdform stdform2" method="get" action="">
                       ...
                       <div class="lg-12 md-12 sm-12">
                               ...
                               <td>
                                ...
                                <td>
                                <select name="transferid" id="transferid"  class="chzn-select" style="width:200px;">
                                <option value="">-select-</option>
                                <?php
                                ...
                                foreach($res as $row)
                                {
                                  ...
                                  $class_name = $obj->getvalfield("m_class","class_name","class_id='$class_id'");
                                ?> 
                                <option value="<?php echo $row['transferid']; ?>"><?php echo $stu_name." / ".$class_name; ?></option>
                                <?php
                                }
                                ?>
                                </select>
                    ...
                    {
                      ?>
                      <!-- <p align="right" style="margin-top:7px; margin-right:10px;"> <a href="pdf_studentwise_atandance_report.php?month=<?php echo $month; ?>&year=<?php echo $year; ?>&transferid=<?php echo $transferid; ?>" class="btn btn-info" target="_blank">
                      ...
                      <tr>
                        <td>
                            <table class="table table-bordered">
                                ...
                                <tr>
                                <td colspan="7">Name : <?php echo $obj->getvalfield("m_student_reg","stu_name","m_student_reg_id='$m_student_reg_id'"); ?></td>
                                </tr>
                                <tr>
                                <td colspan="7">Month : <?php echo $month; ?></td>
                                </tr>
                                <tr>
                                <td colspan="7">Year : <?php echo $year; ?></td>
                                </tr>
                            </table>
                        </td>
                        </tr>
