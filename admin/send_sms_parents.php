...
$pagename = "send_sms_parents.php";
$module = "Send SMS To Parents";
$submodule = "Send SMS To Parents";
$btn_name = "Search";
$keyvalue =0 ;
    ...
    <div class="rightpanel">
      ...
      <div class="span4" style="margin-left:0px;overflow:scroll; height:400px;">
        ...
        foreach($sql as $row_get)
        {
          ?>
          <tr>
           <td><input type="checkbox" name="chk<?php echo $count; ?>" id="chk<?php echo $count; ?>" onClick="addids()" value="<?php echo $row_get['parent_mobile']; ?>"/></td>
           <td><?php echo $slno++; ?></td>
