...
$pagename = "income_group_entry.php";

$module = "Income Master";

$submodule = "INCOME ENTRY MASTER";
...
if (isset($_POST['submit'])) { //print_r($_POST); die;
   ...
   $cwhere = array("ex_group_id" => $ex_group_id, "exp_name" => $exp_name, "exp_date" => $exp_date, "exp_amount" => $exp_amount, "mode" => $mode, "remark" => $_POST['remark']);
   ...
   if ($count > 0 && $keyvalue == 0) {
      ...
      if ($keyvalue == 0) {
         ...
         $form_data = array('ex_group_id' => $ex_group_id, 'exp_name' => $exp_name, 'voucher_no' => $voucher_no, 'exp_date' => $exp_date, 'exp_amount' => $exp_amount, 'mode' => $mode, 'remark' => $remark, 'type' => $type, 'ipaddress' => $ipaddress, 'createdby' => $loginid, 'createdate' => $createdate, 'pay_type' => $pay_type);
...
if (isset($_GET[$tblpkey])) {
   ...
   $voucher_no = $obj->getvoucher($tblname,"voucher_no","1=1 and type='income'");
                     ...
                     <div class="lg-12 md-12 sm-12">
                        ...
                        <table class="table table-bordered">
                           ...
                           <tr>
                              ...
                              <th>Income Name:<span style="color:#F00;">*</span></th>
                           ...
                           <tr>
                              ...
                              <td><select name="ex_group_id" id="ex_group_id" style="width:285px;" class="chzn-select input-xlarge">
                                    ...
                                    $res = $obj->executequery("select * from m_expanse_group where type='income'");
                           ...
                           <tr>
                              ...
                              <td colspan="3"><button type="submit" name="submit" class="btn btn-primary" onClick="return checkinputmaster('ex_group_id,exp_name,exp_date,exp_amount,mode,pay_type'); ">
                                 ...
                                 <a href="income_group_entry.php" name="reset" id="reset" class="btn btn-success">Reset</a>
               ...
               <table class="table table-bordered table-condensed" id="dyntable">
                  ...
                  <thead>
                     ...
                     <tr>
                        ...
                        <th class="head0">Income Group Name</th>
                        ...
                        <?php $chkedit = $obj->check_editBtn("income_group_entry.php", $loginid);

                        if ($chkedit == 1 || $loginid == 1) {  ?>
                           <th class="head0">Edit</th>
                        <?php  }
                        $chkdel = $obj->check_delBtn("income_group_entry.php", $loginid);
                  ...
                  <tbody>
                     ...
                     $res = $obj->executequery("select * from expanse where type='income' order by expanse_id desc");
                     ...
                     ?>
                        ...
                        <tr>
                           ...
                           <?php
                           if ($chkedit == 1 || $loginid == 1) {  ?>
                              <td><a class='icon-edit' title="Edit" href='income_group_entry.php?expanse_id=<?php echo $row_get['expanse_id']; ?>'></a></td>
                           <?php  }
                           if ($chkdel == 1 || $loginid == 1) {  ?>
