...
class PDF_MC_Table extends FPDF
{
  ...
  var $aligns;
    ...
    function Header()
    {
        ...
        $this->Rect('5','5','200','280','F');
         $this->SetFont('Arial','b',20);
        // Move to the right
        $this->SetFont('Arial','b',25);
        $this->Cell(78);
        
        $this->Cell(35,0,$title1,0,1,'C');
        // Line break
        $this->Ln(7);
        ...
        $this->Cell(-1);
        $this->SetFont('Arial','b',11);
        $this->Cell(120,5,"Academic Calendar",0,1,'R');
        $this->Ln(1);
        }
        if($fee_head_id!="")
        {
        ...
        $this->Cell(30,8,'From Date',1,0,'L',0);
        $this->Cell(30,8,'To Date',1,0,'L',0);
        $this->Cell(124.5,8,'Subject',1,1,'L',0);
