...
$pagename = "complication_certificate_page.php";
$module = "Completion Certificate";
$submodule = "COMPLETION CERTIFICATE";
$btn_name = "Save";
$keyvalue = 0;
...
if (isset($_POST['submit'])) {
  ...
  if ($count > 0) {
    ...
    //update
    $form_data = array('m_student_reg_id' => $m_student_reg_id, 'father_name' => $father_name, 'admission_year' => $admission_year, 'course_name' => $course_name, 'address' => $address, 'district' => $district, 't_day' => $date, 'app_no' => $app_no, 'enroll_no' => $enroll_no, 'certificate_type' => $certificate_type, 'd_o_m_issue' => $d_o_m_issue, 'createdate' => $createdate, 'ipaddress' => $ipaddress);
    // print_r($form_data);
    // die;
    ...
    $process = "insert";
    // die;
    echo "<script>location='complication_certificate_page.php?action=$action'</script>";
...
<body>
                    ...
                    <table class="table table-bordered">
                      ...
                      <tr>
                        <td colspan="3">
                          ...
                          <a href="complication_certificate_page.php" name="reset" id="reset" class="btn btn-success">Reset</a>
          ...
          <table class="table table-bordered" id="dyntable">
            ...
            <thead>
              <tr>
                ...
                <?php $chkdel = $obj->check_delBtn("complication_certificate_page.php", $loginid);
            ...
            <tbody>
              ...
              $res = $obj->executequery("select * from complicaction_certificate where certificate_type='complication' order by cc_id desc");
              ...
              ?>
                <tr>
                  ...
                  <td width="10%"><a class="icon-print" style="text-align: center; cursor: pointer;" data-toggle="modal_party" title="Print" target="_blank" href="complication-certificate.php?m_student_reg_id=<?php echo $row_get['m_student_reg_id'] ?>"></a></td>
  ...
  <script>
    ...
    function getid(m_student_reg_id) {
      ...
      // alert("sshol");
      var $url = 'complication_certificate_page.php?m_student_reg_id=' + m_student_reg_id;
      ...
      if (print_copy == "") {
        ...
        jQuery.ajax({
          ...
          success: function(data) {
            ...
            if (data == 1) {
              print('complication-certificate.php?cc_id=<?php echo $cc_id; ?>');
            }
