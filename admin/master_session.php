                        ...
                        <form class="stdform stdform2" method="post" action="">
                            ...
                            <div class="lg-12 md-12 sm-12">
                                <table id="mytable01" align="center" class="table table-bordered table-condensed">
                                    <tr>
                                        <th> <span style="color:#F00;"> * </span>From Date</th>
                                        <th> <span style="color:#F00;"> * </span>To Date</th>
                                        <th> <span style="color:#F00;"> * </span>Session</th>
                                        <th>&nbsp;</th>
                                    </tr>
                                    <tr>
                    ...
                    <table class="table table-bordered" id="dyntable">
                        ...
                        <thead>
                            <tr>
                                ...
                                <?php  }
                                $chkdel = $obj->check_delBtn("master_session.php", $loginid);
