...
<body >
    ...
    <div class="container">
        <div class="row">
            <div class="span12">
                <div class="" style="border: 1px solid rgb(212, 212, 212);padding:5px;">
                        ...
                        <?php 
                            ...
                            { ?>
                                ...
                                <h5 style="margin-bottom:10px;"><u>FOR SCHOLARSHIP REGISTRATION </u></h5> 
                            </center>
                         <?php } ?>
                   ...
                   <br>
                   <h5>Registration : Enter your details</h5><br>
                   <table class="table table-bordered" style="margin-bottom:5px;">
                                <tr>
                               ...
                               <tr>
                                   <td colspan="5"><h5>Correspondence Address Details</h5></td>
                               </tr>
                        <tr>
                            <td>State</td>
                            <td colspan="4"></td>
                    ...
                    <div style="float: right;text-align: center;">
                        <div style="border:1px solid black;padding: 20px;width:100px;"></div>
                         <h5 style="margin-top:5px;">Student Signature</h5>
                    </div>
                    <br><br><br><br>
                </div>
            </div>
