...
foreach ($res as $rowget) {
    ...
    $income_certif_expiry_date = $obj->dateformatindia($rowget['income_certif_expiry_date']);
    $cat_name = $obj->getvalfield("m_category", "cat_name", "category_id='$category_id'");
    $cast = $rowget['cast'];
    $f_income = $rowget['f_income'];
    $address_village = $rowget['address2'];
    $tehsil = $rowget['tehsil'];
    $ward_no = $rowget['ward_no'];
    $post_office = $rowget['post_office'];
   // $address_village = $obj->getvalfield("student_info", "address", "m_student_reg_id='$m_student_reg_id'");
    //$tehsil = $obj->getvalfield("student_info", "tehsil", "m_student_reg_id='$m_student_reg_id'");
    //$ward_no = $obj->getvalfield("student_info", "ward_no", "m_student_reg_id='$m_student_reg_id'");
                        ...
                        <div class="span12">
                            <table class="table table-bordered" style="margin-bottom:5px;">
                                ...
                                <tr>
                                    ...
                                    <td rowspan="4" colspan="2" width="140">
                                ...
                                <tr>
                                    ...
                                    <td><h5>Income Certificate Expiry Date</h5></td>
                                    <td colspan="2"><?php echo $income_certif_expiry_date; ?></td>
                                ...
                                <tr>
                                    <td>
                                        <h5>Village/Mohalla: </h5>
                                    </td>
                                    <td><?php echo $address_village; ?></td>
                                    <td><h5>Ward Number:</h5> </td>
                                    <td><?php echo $ward_no; ?></td>
                                    <td>
                                        <h5>Tehsil: </h5>
                                    </td>
                                    <td colspan="3"><?php echo $tehsil; ?></td>
                                </tr>
								<tr>
                                    <td>
                                        <h5>Post Office: </h5>
