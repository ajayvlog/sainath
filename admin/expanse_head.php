...
$pagename = "expanse_head.php";
$module = "Expense Master";
$submodule = "EXPENSE MASTER";
$btn_name = "Save";
$keyvalue = 0;
...
if (isset($_POST['submit'])) {  //print_r($_POST); die;
  ...
  if ($count > 0 && $keyvalue == 0) {
    ...
    //insert
    if ($keyvalue == 0) {
      $form_data = array('group_name' => $group_name, 'status' => $status, 'type' => $type, 'ipaddress' => $ipaddress, 'createdby' => $loginid, 'createdate' => $createdate);
                ...
                <table class="table table-bordered">
                  ...
                  <tr>
                    ...
                    <td><button type="submit" name="submit" class="btn btn-primary" onClick="return checkinputmaster('group_name,status'); ">
                      ...
                      <a href="expanse_head.php" name="reset" id="reset" class="btn btn-success">Reset</a>
          ...
          <table class="table table-bordered" id="dyntable">
            ...
            <thead>
              <tr>
                ...
                <th width="18%" class="head0">Expense Name</th>
                <th width="18%" class="head0">Status</th>
                <?php $chkedit = $obj->check_editBtn("expanse_head.php", $loginid);

                if ($chkedit == 1 || $loginid == 1) {  ?>
                  <th width="9%" class="head0">Edit</th>
                <?php  }
                $chkdel = $obj->check_delBtn("expanse_head.php", $loginid);
            ...
            <tbody>
              ...
              $res = $obj->executequery("select * from m_expanse_group where type = 'expense' order by ex_group_id desc");
              ...
              ?>
                <tr>
                  ...
                  if ($chkedit == 1 || $loginid == 1) {  ?>
                    <td><a class='icon-edit' title="Edit" href='expanse_head.php?ex_group_id=<?php echo $row_get['ex_group_id']; ?>'></a></td>
                  <?php  }
                  if ($chkdel == 1 || $loginid == 1) {  ?>
                    <td>
