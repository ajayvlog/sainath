...
$crit = " where type = 'expense' and exp_date between '$from_date' and '$to_date'";
        ...
        <div class="contentinner content-dashboard">
            ...
            <table class="table table-bordered table-condensed">
              ...
              <tr>
                ...
                <td><select name="ex_group_id" id="ex_group_id" style="width:285px;" class="chzn-select input-xlarge">
                    ...
                    <?php
                    $slno = 1;
                    $res = $obj->fetch_record("m_expanse_group");
          ...
          <table class="table table-bordered" id="tblData">
            <thead>
              <tr>
                <th>S.No.</th>
                <th style="text-align: center;">Expense Group Name</th>
