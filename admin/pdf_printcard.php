...
if(isset($_GET['m_student_reg_id']))
{
    ...
    {
          $sem_id  = $rowedit['sem_id'];
          $m_student_reg_id  = $rowedit['m_student_reg_id'];
          $transferid  = $rowedit['transferid'];
          $sessionid = $rowedit['sessionid'];
          ...
          $dob = $obj->dateformatindia($obj->getvalfield("m_student_reg","dob","m_student_reg_id='$m_student_reg_id'"));
          ...
          $blood_group = $obj->getvalfield("m_student_reg","blood_group","m_student_reg_id='$m_student_reg_id'");
...
class PDF_MC_Table extends FPDF
{
  ...
  var $aligns;
    ...
    function Header()
    {
        global $title1,$title,$stu_name,$mobile,$pan_no,$img_name,$email,$blood_grp,$transferid,$enrollment,$dob,$session_name,$father_name,$imgname,$class_name,$imgpath,$sem_name,$blood_group,$company_address,$city,$college_name,$college_mobile;
      ...
      if($imgname!="")
      {
       $this->Image("uploaded/studentimg/".$imgname,2,10,20,20);
      }
      else
      {
      ...
      $this->SetFont( 'Arial', 'b',6); 
       ...
       // $this->SetY(1); 
        ...
        $this->SetY(6);
        $this->SetX(25);
        $this->Cell(10,10,'Student Name',0,0,'');
        ...
        $this->SetY(9);
        $this->SetX(48);
        $this->MultiCell(50,4,strtoupper($stu_name),0,'L');
        ...
        $this->SetY(17.5); 
        $this->SetX(25);
        $this->Cell(0,10,'Course Name',0,0,'L');
        $this->SetY(21);
        $this->SetX(45);
        $this->Cell(2,3,':',0,0,'');
        $this->SetFont( 'Arial', '',7);
        $this->SetY(17.5);
        $this->SetX(48);
        $this->Cell(0,10,$class_name,0,0,'L');

        $this->SetFont( 'Arial', 'b',7);
        $this->SetY(21.5); 
        $this->SetX(25);
        $this->Cell(0,10,'Semester',0,0,'L');
        $this->SetY(25);
        $this->SetX(45);
        $this->Cell(2,3,':',0,0,'');
        $this->SetFont( 'Arial', '',7);
        $this->SetY(21.5);
        $this->SetX(48);
        $this->Cell(0,10,$sem_name,0,0,'L');


         $this->SetFont( 'Arial', 'b',7);
        $this->SetY(25.5); 
        $this->SetX(25);
        $this->Cell(0,10,'Blood Group',0,0,'L');
        $this->SetY(28.8);
        $this->SetX(45);
        $this->Cell(2,3,':',0,0,'');
        $this->SetFont( 'Arial', '',7);
        $this->SetY(25.5);
        $this->SetX(48);
        $this->Cell(0,10,$blood_group,0,0,'L');

        
        $this->SetFont( 'Arial', 'b',7); 
        $this->SetY(29.5); 
        $this->SetX(25);
        $this->Cell(0,10,'Session',0,0,'L');
        $this->SetY(33);
        $this->SetX(45);
        $this->Cell(2,3,':',0,0,'');
        $this->SetFont( 'Arial','',7);
        $this->SetY(29.5);
        $this->SetX(48);
        $this->Cell(0,10,$session_name,0,0,'L');

        $this->SetY(33.5); 
        $this->SetFont( 'Arial', 'b',7); 
        $this->SetX(25);
        $this->Cell(0,10,'Parents Name',0,0,'L');
        $this->SetY(37);
        $this->SetX(45);
        $this->Cell(2,3,':',0,0,'');
        $this->SetFont( 'Arial','',7); 
        $this->SetY(33.5);
        $this->SetX(48);
        $this->MultiCell(0,10,$father_name,0,'L');
       ...
       // $this->Cell(10,10,'Address',0,0,'C');
        ...
        $this->MultiCell(88,10,$company_address." ".$city." ".","." ".$college_mobile,0,'C',1);
