...
class PDF_MC_Table extends FPDF
{
    ...
    function Header()
    {
        ...
        $this->Cell(33, 8, 'Class_Name', 1, 0, 'L', 0);
        $this->Cell(33, 8, 'Sem/Year', 1, 0, 'L', 0);
        $this->Cell(33, 8, 'Total_Amt', 1, 0, 'R', 0);
        $this->Cell(33, 8, 'Total_Paid', 1, 0, 'R', 0);
        $this->Cell(33, 8, 'Total_Bal', 1, 1, 'R', 0);
        $this->SetWidths(array(15, 72, 35, 33, 33, 33, 33, 33));
...
foreach ($res as $row_get) {
    ...
    $pdf->Row(array($slno++, $stu_name, $biometric_code, $class_name, $sem_name, number_format($total_fee, 2), number_format($paid_amt, 2), number_format($bal_amount, 2)));
