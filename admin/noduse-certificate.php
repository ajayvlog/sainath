...
<body>
    <div class="wrapper">
        <div class="container center">
            <h2 style="line-height:0px;" class="center"> सांईनाथ पैरामेडिकल कॉलेज, उमरिया (म०प्र०)</h2>
            <small class="center" style="margin-top: -10px;">आर.सी. स्कूल के पास कछरवार रोड उमरिया (म.प्र.) </small><br>
            <small class="center" style="margin-top: -12px;">Email- sainathcollege2012@gmail.com, snpc2013@refiffmail.com` </small>
            <br><br>
            ...
            <br><br>
            <h2 style="margin-top: 5%;"><u>Noduse Certificate</u></h2>
            <br>
            <p> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; प्रमाणित किया जाता है कि <b><?php echo $stu_name; ?></b> पिता <b><?php echo $father_name; ?></b> निवासी <?php echo $address; ?>, जिला- <?php echo $district; ?> ने सत्र <?php echo $admission_year; ?> बैच के <?php echo $course_name; ?> पाठ्यक्रम के नियमित
                छात्र थे/छात्रा थी। ।
            </p>
            <br>
            ...
            <p class="center" style="margin-top: 20px;"><?php echo $course_name; ?> पाठ्यक्रम में इनका परीक्षा परिणाम उत्तीर्ण रहा।</p>
            <p class="center"> परीक्षा उपरान्त महाविद्यालय में इनकी कोई भी बकाया शुल्क शेष नहीं
                है।</p>
            <p class="center"> संस्था के प्रति इनका कार्य व्यवहार उत्तम था ।</p>
            <p class="center"><b>संस्था इनके उज्जवल भविष्य की कामना करती है।</b></p><br><br><br><br><br><br>
