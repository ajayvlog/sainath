...
//$module = "Masters";
//$keyvalue="";
$college_name = $obj->getvalfield("college_setting","college_name","3 = '3'");
$mobile = $obj->getvalfield("college_setting","mobile","3 = '3'");
$email = $obj->getvalfield("college_setting","email","3 = '3'");
$city = $obj->getvalfield("college_setting","city","3 = '3'");
$address = $obj->getvalfield("college_setting","address","3 = '3'");
...
if(isset($_GET['fee_payid']))
{
    ...
    $res = $obj->executequery("select * from fee_payment where fee_payid = '$fee_payid'");
    foreach($res as $rowedit)
    {
    
    $transferid  = $rowedit['transferid'];
    $fee_payid  = $rowedit['fee_payid']; 
    $fee_head_id  = $rowedit['fee_head_id']; 
    $feehead_name = $obj->getvalfield("m_fee_head","fee_head_name","fee_head_id='$fee_head_id'");
    $receipt_no = $rowedit['reciept_no'];
	...
	// $mobile=$obj->getvalfield("m_student","f_mobile","studentid = '$studentid'");
...
class PDF_MC_Table extends FPDF
{
  ...
  var $aligns;
	function Header()
	{ 
	   global $title1,$title2,$class_name,$college_name,$mobile,$email,$address,$city,$stu_name;
...
$pdf->Cell(120,4,$college_name,'0',1,'C',0);
$pdf->Ln(2);

$pdf->SetFont('Arial','b',7);
$pdf->Cell(40,1,"Mobile No:".$mobile.",",'0',1,'C',0);

$pdf->SetFont('Arial','b',7);
$pdf->Cell(110,-1,"City:".$city.",",'0',1,'C',0);

$pdf->SetFont('Arial','b',7);
$pdf->Cell(121,1,"Email Id:".$email,'0',1,'R',0);
$pdf->Ln(2);
$pdf->SetFont('Arial','b',7);
...
$pdf->SetTextColor(0,0,0);
$pdf->Cell(130,5,'Cash Receipt','0',1,'C',0);
$pdf->Ln(3);
$pdf->SetFont('Arial','b',9);
$pdf->SetTextColor(0,0,0);
$pdf->SetY(35);
$pdf->Cell(30,4,'Receipt No. : '.$receipt_no,'0',0,'L',0);
// //$pdf->Ln(2);
$pdf->SetX(90);
$pdf->SetFont('Arial','b',9);
$pdf->SetTextColor(0,0,0);
...
$pdf->SetFont('Arial','b',9);
$pdf->SetTextColor(0,0,0);
$pdf->Cell(30,4,'Fee Head : '.$feehead_name,'0',1,'L',0);
$pdf->Ln(3);
$pdf->SetY(47);
$pdf->SetX(10);
$pdf->SetFont('Arial','b',8);
$pdf->Cell(100,5,"Received with thanks from ".strtoupper($stu_name),0,1,'L');
...
$pdf->SetFont('Arial','b',8);
$pdf->SetTextColor(0,0,0);
$pdf->Cell(90,5,'Sign of Student',0,0,'L',0);
$pdf->SetFont('Arial','b',8);
$pdf->SetTextColor(0,0,0);
$pdf->Cell(40,5,'For :-'.$college_name,0,0,'R',0);
$pdf->Ln(3);
...
$pdf->Ln(2);
$pdf->SetFont('Arial','b',7);
$pdf->Cell(45,1,"Mobile No:".$mobile.",",'0',1,'C',0);

 $pdf->SetFont('Arial','b',7);
 $pdf->Cell(114,-1,"City:".$city.",",'0',1,'C',0);
...
$pdf->SetFont('Arial','b',13);
$pdf->SetTextColor(0,0,0);
$pdf->Cell(130,26,'Cash Receipt','0',1,'C',0);
$pdf->Ln(3);
$pdf->SetFont('Arial','b',9);
$pdf->SetTextColor(0,0,0);
$pdf->SetY(138);
...
$pdf->Ln(3);
	...
	$pdf->SetY(149);
		$pdf->SetX(10);
		$pdf->SetFont('Arial','b',8);
		$pdf->Cell(100,5,"Received with thanks from ".$stu_name,0,1,'L');
...
$pdf->SetFont('Arial','b',8);
$pdf->SetTextColor(0,0,0);
$pdf->Cell(30,5,'For Office',0,0,'R',0);
