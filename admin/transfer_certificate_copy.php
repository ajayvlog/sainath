    ...
    <div class="container">
        <page size="A4">
            <center>
                ...
                <span>आर. सी. स्कूल के बगल से , कछवार रोड उमरिया (म.प्र.) </span><br>
            ...
            <center><br><br>
                <div>
                    <h3 style="line-height: 10px;">स्थानांतरण प्रमाण पत्र</h3>
                </div>
            </center><br>
            <?php
            ...
            <p>&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;यह साईनाथ पैरामेडिकल महाविद्यालय , उमरिया की वर्ष <?php echo $obj->dateformatindia($participation_date); ?> की परीक्षा में <b><?php echo $status; ?></b> होने के पश्चात् महाविद्यायलय छोड़ रहा / रही है। </p>
            <center>
                <center>
