...
{
	$emp_tran_id = addslashes(trim($_GET['emp_tran_id']));

   // $employee_id = addslashes(trim($_GET['employee_id']));
    
    $res = $obj->executequery("select * from emp_trancaction where emp_tran_id = '$emp_tran_id'");
    ...
    $mode = $rowedit['mode'];
    $employee_id = $rowedit['employee_id'];
...
class PDF_MC_Table extends FPDF
{
  ...
  var $aligns;
	function Header()
	{ 
	   global $title1,$title2,$class_name,$college_name,$mobile,$email,$address,$city,$emp_name,$payment_type1,$remark,$mode,$pay_date;
...
$pdf->Cell(65,1,"Mobile No:".$mobile.",",'0',1,'C',0);
...
$pdf->SetTextColor(0,0,0);
$pdf->Cell(130,5,'Employee Payment Receipt','0',1,'C',0);
$pdf->Ln(3);
...
$pdf->Ln(3);
		...
		$pdf->Cell(100,5,$payment_type1." with thanks from ".strtoupper($emp_name),0,1,'L');
		...
		$pdf->SetX(10);
		$pdf->SetFont('Arial','b',8);
		$pdf->MultiCell(150,0,"By ".$mode." ".$remark,0,'L');
...
$pdf->SetFont('Arial','b',8);
$pdf->SetTextColor(0,0,0);
$pdf->Cell(90,5,'Sign of Employee',0,0,'L',0);
$pdf->SetFont('Arial','b',8);
$pdf->SetTextColor(0,0,0);
...
$pdf->SetFont('Arial','b',13);
$pdf->SetTextColor(0,0,0);
$pdf->Cell(130,10,'Employee Payment Receipt','0',1,'C',0);
$pdf->Ln(3);
$pdf->SetFont('Arial','b',9);
$pdf->SetTextColor(0,0,0);
$pdf->SetY(138);
...
$pdf->Ln(3);
	$pdf->SetY(145);
		$pdf->SetX(10);
		$pdf->SetFont('Arial','b',8);
		$pdf->Cell(100,5,$payment_type1." with thanks from ".$emp_name,0,1,'L');
...
$pdf->SetFont('Arial','b',8);
$pdf->SetTextColor(0,0,0);
$pdf->Cell(30,5,'For Employee',0,0,'R',0);
