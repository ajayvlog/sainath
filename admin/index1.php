               ...
               <div class="row-fluid">
                  <div class="span12">
                     <ul class="widgeticons row-fluid">
                        ...
                        <li class="one_fifth"><a href="m_student_reg.php"><small>&nbsp;</small>
                              <h1><?php echo $tot_student; ?></h1><span>Total Student</span>
                           </a></li>

                        <li class="one_fifth">
                           <a href="#" style="color: black;">
                              <span>Total Active Student : <?php echo $tot_student_active; ?></span>
                              <span>Total Inactive Student : <?php echo $tot_student_inactive; ?></span>
                              <span></span>
                              <span></span>
                              <span></span>
                           </a>
                        ...
                        <li class="one_fifth"><a href="hostel_list.php"><small>&nbsp;</small>
                              <h1><?php echo $tot_hostler; ?></h1><span>Total Hosteller</span>
                           </a></li>

                        <li class="one_fifth"><a href="employee_master.php"><small>&nbsp;</small>
                              <h1><?php echo $tot_employee; ?></h1><span>Total Employee</span>
                           </a></li>

                        <!--  <li class="one_fifth"><a><small>&nbsp;</small><h1><span id="sms_bal_trans"></span></h1><strong>Credit SMS Balance</strong></a></li> -->

                        <li class="one_fifth"><a href="fee_report.php"><small>&nbsp;</small>
                              <h1><?php echo $today_fee; ?></h1><span>Today Fee</span>
                           </a></li>

                        <li class="one_fifth"><a href="view_birthdaylist.php"><small>&nbsp;</small>
                              <h1><?php echo $total_birth; ?></h1><span>Today Birthday</span>
                           </a></li>

                        <li class="one_fifth"><a href="expanse_group_entry.php"><small>&nbsp;</small>
                              <h1><?php echo $tot_expanse; ?></h1><span>Today Expense</span>
                           </a></li>

                        <li class="one_fifth"><a href="income_group_entry.php"><small>&nbsp;</small>
                              <h1><?php echo $tot_income; ?></h1><span>Today Income</span>
                           </a></li>

                        <li class="one_fifth"><a href="enquiry_report.php"><small>&nbsp;</small>
                              <h1><?php echo $tot_enquiry; ?></h1><span>Total Enquiry</span>
                           </a></li>

                        <!-- <li class="one_fifth"><a href="m_student_reg.php"><small>&nbsp;</small><h1><?php //echo $tot_session_stu; 
                                                                                                         ?>,Ac<?php //echo $tot_session_stuactive; 
                                                                                                      ?>,In<?php //echo $tot_session_stuinactive; 
                                                                                                            ?></h1><span>Total Students <?php //echo $session_name; 
                                                                                                                                          ?></span></a></li> -->

                        <li class="one_fifth">
                           <a href="#">

                              <span>Students <?php echo $session_name; ?> : <?php echo $tot_session_stu; ?></span>
                              <span>Total Active : <?php echo $tot_session_stuactive; ?></span>
                              <span>Total Inactive : <?php echo $tot_session_stuinactive; ?></span>
                           </a>
                        </li>
                        ...
                        <li class="one_fifth">
                           <a href="#">
                              ...
                              <span>Total D.M.L.T : <?php echo $tot_dmlt; ?></span>
                              <span>Total Active : <?php echo $tot_dmltactive; ?></span>
                              <span>Total Inactive : <?php echo $tot_dmltinactive; ?></span>
                           </a>
                        </li>
                        ...
                        <li class="one_fifth">
                           <a href="#">
                              ...
                              <span>Total B.M.L.T : <?php echo $tot_bmlt; ?></span>
                              <span>Total Active : <?php echo $tot_bmltactive; ?></span>
                              <span>Total Inactive : <?php echo $tot_bmltinactive; ?></span>
                           </a>
                        </li>
                        ...
                        <li class="one_fifth">
                           <a href="#">
                              ...
                              <span>Total O.T.TECH : <?php echo $tot_ot_tech; ?></span>
                              <span>Total Active : <?php echo $tot_ot_techactive; ?></span>
                              <span>Total Inactive : <?php echo $tot_ot_techinactive; ?></span>
                           </a>
                        </li>
