...
$pagename = "character_certificate_page.php";
$module = "CHARACTER CERTIFICATE";
$submodule = "Character Certificate";
$btn_name = "Save";
$keyvalue =0 ;
$tblname = "charcter_certificate";
$tblpkey = "cc_id";
if(isset($_GET['cc_id']))
$keyvalue = $_GET['cc_id'];
else
                  ...
                  <div class="row-fluid">
                   ...
                   <div class="alert alert-success">
                     ...
                     <tr>
                        ...
                        ?>
                        <option value="<?php echo $row['m_student_reg_id']; ?>"><?php echo $row['stu_name']." / ".$class_name; ?></option>
                        <?php
                        }
                        ?>
                        </select>
...
{ 
  ...
  if(m_student_reg_id!="" && sem_id!="" && sessionid!="")
  {
    jQuery.ajax({
      type: 'POST',
      url: 'save_character_certificate.php',
 ...
 var m_student_reg_id = jQuery("#m_student_reg_id").val();
      jQuery.ajax({
      type: 'POST',
      url: 'show_charcter_certificate.php',
...
function getid(m_student_reg_id)
  { 
    ...
    var $url = 'character_certificate_page.php?m_student_reg_id='+m_student_reg_id;
